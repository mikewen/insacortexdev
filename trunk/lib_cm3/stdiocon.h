...
/*
 * RCS $Revision: 119828 $
 * Checkin $Date: 2006-11-10 15:33:41 +0000 (Fri, 10 Nov 2006) $
...
#pragma __printf_args
#endif
extern _ARMABI int printf(const char * __restrict /*format*/, ...);
   /*
...
#pragma __printf_args
#endif
extern _ARMABI int _printf(const char * __restrict /*format*/, ...);
   /*
...
#pragma __printf_args
#endif
extern _ARMABI int sprintf(char * __restrict /*s*/, const char * __restrict /*format*/, ...);
   /*
...
#pragma __printf_args
#endif
extern _ARMABI int _sprintf(char * __restrict /*s*/, const char * __restrict /*format*/, ...);
   /*
...
#pragma __scanf_args
#endif
extern _ARMABI int scanf(const char * __restrict /*format*/, ...);
   /*
...
#pragma __scanf_args
#endif
extern _ARMABI int _scanf(const char * __restrict /*format*/, ...);
   /*
...
#if !defined(__STRICT_ANSI__) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__)
/* C99 additions */
extern _ARMABI int vfscanf(FILE * __restrict /*stream*/, const char * __restrict /*format*/, __va_list);
extern _ARMABI int vscanf(const char * __restrict /*format*/, __va_list);
extern _ARMABI int vsscanf(const char * __restrict /*s*/, const char * __restrict /*format*/, __va_list);
#endif
extern _ARMABI int _vfscanf(FILE * __restrict /*stream*/, const char * __restrict /*format*/, __va_list);
extern _ARMABI int _vscanf(const char * __restrict /*format*/, __va_list);
extern _ARMABI int _vsscanf(const char * __restrict /*s*/, const char * __restrict /*format*/, __va_list);

extern _ARMABI int vprintf(const char * __restrict /*format*/, __va_list /*arg*/);
   /*
    ...
    *          output error occurred.
    */
extern _ARMABI int _vprintf(const char * __restrict /*format*/, __va_list /*arg*/);
   /*
...
extern _ARMABI int vfprintf(FILE * __restrict /*stream*/,
                    const char * __restrict /*format*/, __va_list /*arg*/);
   /*
...
extern _ARMABI int fputc(int /*c*/, FILE * /*stream*/);
    ...
    */
extern _ARMABI int fputs(const char * __restrict /*s*/, FILE * __restrict /*stream*/);
   /*
...
extern _ARMABI int fgetpos(FILE * __restrict /*stream*/, fpos_t * __restrict /*pos*/);
   /*
...
extern _ARMABI int fseek(FILE * /*stream*/, long int /*offset*/, int /*whence*/);
    ...
    */
extern _ARMABI int fsetpos(FILE * __restrict /*stream*/, const fpos_t * __restrict /*pos*/);
   /*
    * sets  the file position indicator for the stream pointed to by stream

...
//+ [Acco Novembre 2007]  PAssage à la 2007b
//   J'ai viré le capcom de Thierry (codeur incrémentaux) pour utilser le timer T3 en
//   incrémental interface mode sur les pates P3.4 et P3.6. 
//   IMPECCABLE ! pas d'interruption pas d'erreur de comptage...
//   Pour définir le sens de comptage (permutation de P3.4 et P3.6 éventuelle utilisez
//   la clef SENS (0 ou 1) 
//   Ajout de PAS (la finesse) 
//+ [Acco Dec 2008]
//  ajout de signed int lire_vitesse() , float lire_vitesse est renommée en lire_vitesse_float()
//=================================================================================================

// DEFINISSEZ ICI le sens de comptage du codeur incrémental de position 
//#define SENS 1
#define SENS 0

#define PAS  (0.004254236) // Finesse du codeur incrémental en metres
#define KD   (1.919) // Kd = Vitesse [pas/s] / Vitesse [unite ADC/s]
...
//________________________________________________________________
// ROLE : renvoie la vitesse lue par l'ADC (signed int). ADC en scrutation
//     0V => -511   2.5V => 0  5V => 512
// DUREE : 33us environ
// TEST (résumé) : SIMU seule. Testée pour 0V, 2.5V et 5V
//________________________________________________________________
...
//________________________________________________________________
// ROLE : initialise le timer T3 en mode incrmental interface sur
//   les voies P3.4 et P3.6
// DUREE : non mesurée, pas important
// TEST (résumé) : voir fonction suivante
//________________________________________________________________

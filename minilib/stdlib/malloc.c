...
void *malloc(size_t nbytes)
{
	return _malloc (nbytes); //call system and user specific implementation for allocating memory
}

void free(void *aptr)
{
	_free (aptr); //call system and user specific implementation for releasing memory
}

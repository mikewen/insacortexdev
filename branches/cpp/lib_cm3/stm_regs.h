...
#define ADC_EXTSEL_IS_TIM1_CC1		(0<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_TIM1_CC2		(1<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_TIM1_CC3		(2<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_TIM2_CC2		(3<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_TIM3_TRGO	    (4<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_TIM4_CC4		(5<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_EXTI			(6<<ADC_EXTSEL_SHIFT)
#define ADC_EXTSEL_IS_SWSTART		(7<<ADC_EXTSEL_SHIFT)

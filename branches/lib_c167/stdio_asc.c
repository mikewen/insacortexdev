/* STDIO_ASC.c ****************************************************************
 *	Entrées-Sorties série via le port synchrone SSC en simu                   *
 *                        via le port asynchrone ASCe en réel                 *
 *  stdio.h est donc utilisable (prontf etc.) et visualisables sur la         *
 *  "serial windows #1" de Keil.
 *   6 Janvier 2007 pascal Acco												  *
 ******************************************************************************
 ******************************************************************************
 ...
 *				- Mode simulé : les E/S passent par la liasion série SSC0     *

...
avr32a_context idle_task_context;
void tpl_sleep(void);

#define OS_START_SEC_VAR_32BIT
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_VAR)
idle_stack[SIZE_OF_IDLE_STACK/sizeof(tpl_stack_word)]={0xACDC0000,0xACDC0001,0xACDC0002,0xACDC0003,0xACDC0012,0,(unsigned int) &tpl_sleep, portINITIAL_SR};
    ...
    CONST(tpl_proc_id, OS_APPL_DATA) proc_id)
{
	...
	avr32a_context *ic = static_desc->context.ic;

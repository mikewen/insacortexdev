function [K,S,E,Ky,Sy,Ey]=calcul_retour_etat(K,Tau,Kd,N)
...
Q(N+1:(2*N-1),N+1:(2*N-1))=Q(N+1:(2*N-1),N+1:(2*N-1))*0.001;
...
[Ky,Sy,Ey]=lqrd(ntrot.a,ntrot.b,C'*Q*C,R,0.002);

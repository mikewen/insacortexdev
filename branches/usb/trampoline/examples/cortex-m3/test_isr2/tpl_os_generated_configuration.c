...
void tpl_init_tick_timer()
{
	...
	*(portNVIC_SYSTICK_CTRL) = portNVIC_SYSTICK_CLK | portNVIC_SYSTICK_INT | portNVIC_SYSTICK_ENABLE;
	 SCB->SHPR[2] |= (15 << 28) ; //set systick interrupt priority to 15
...
tpl_stack_word  EXTI0_stack[256/sizeof(tpl_stack_word)];


#define EXTI0_STACK { EXTI0_stack, 256}
...
void EXTI0_IRQHandler(void)
{
	...
	tpl_central_interrupt_handler(EXTI0_id);
 ...
 * ISR2 EXTI0 context
 */
cm3_context EXTI0_int_context;

#define EXTI0_CONTEXT { &EXTI0_int_context }
#define OS_START_SEC_CODE
#include "tpl_memmap.h"
/*
 * ISR EXTI0 function prototype
 */
...
#include "tpl_memmap.h"
/*
 * Static descriptor of ISR EXTI0
 */
CONST(tpl_proc_static, OS_CONST) EXTI0_isr_stat_desc = {
    /* context                  */ EXTI0_CONTEXT,
    /* stack                    */ EXTI0_STACK,
    /* entry point (function)   */ EXTI0_function,
    /* internal ressource       */ NULL,
    /* isr id                   */ EXTI0_id,
#ifdef WITH_OSAPPLICATION
    /* OS application id        */  $APP_ID$,
...
tpl_isr_static EXTI0_isr_helper = {
  /* helper */ NULL,
  /* next */   NULL,
  /* id */     EXTI0_id
};
...
/*
 * Dynamic descriptor of ISR EXTI0
 */
VAR(tpl_proc, OS_VAR) EXTI0_isr_desc = {
    /* resources            */            NULL,
#if WITH_MEMORY_PROTECTION == YES

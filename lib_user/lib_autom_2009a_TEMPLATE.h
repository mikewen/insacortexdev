...
________________________________________________________________________________________
USAGE
	include a peripheral lib that provides Set_Position(), Lire_Position() and Lire_Vitesse()
	routines
	include lib_autom_2009a.h in your application
________________________________________________________________________________________
REVS
...
//  et l'intégrale de l'erreur de Pos

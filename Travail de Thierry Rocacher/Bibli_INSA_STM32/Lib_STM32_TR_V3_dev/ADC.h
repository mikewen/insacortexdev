...
//	- Voie de 0 à 15 : correspond au rang de la voienuméro de la voie ADC à lire
...
float ADC_Init(char Nb_Canaux, char Seq_Canaux[], float T_samp_us, float  Freq_ADC_kHz);
//	- Nb_Canaux : de 1 à 16, c'est le nombre de canaux scannés
//	- Seq_Canaux[] Table qui doit avoir la taille Nb_Canaux. Elle donne l'ordre d'acuisition
//					des voies
//		- Seq_Canaux[0]  = 0 à 15 : contient la voie à acquérir	pour le rang 0 (le premier)
//		- Seq_Canaux[n] = 0 à 15 : contient la voie à acquérir	pour le rang n 
///	- T_samp_us : Temps de fermeture de l'interupteur (echantillonnage de la capa ADC) en µs
//	- Freq_ADC_kHz : fréquence d'attaque de l'ADC en MHz, maxi 14 MHz
//  - La fonction renvoie la valeur recalculée de la période d'échantillonnage Te en us

vu16 ADC_Lire(char Rang_Scan);
//	- Rang_Scan de 0 à 15 : renvoie la voie ADC correspondant au rang (Rang_Scan)
//							de l'ensemble des voies scannées

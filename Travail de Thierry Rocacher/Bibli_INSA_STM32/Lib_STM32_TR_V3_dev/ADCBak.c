...
// JEXTSEL[2:0]=000
// Bit 11 ALIGN=1: Data alignment = 1 Left aligned (16 bits)
...
ADC1->CR2= (ADC1->CR2) |1<<11 | 1<<8 | 1<<1; // Left ALigned / DMA on / Continuous
...
DMA1_Channel1->CMAR	= (unsigned long)Start_Adress;
...
DMA1_Channel1->CCR = 0;
DMA1_Channel1->CCR =(DMA1_Channel1->CCR) | 3<<12| 1<<10|1<<8|1<<7|1<<5|1;

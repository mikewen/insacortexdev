...
#include "lib_usartx_irq.h"     // import configuration NUM_USART and BAUDRATEx
...
#define __USART_INTERRUPTS 	(1<<(NUM_USART-1))
...
//________________________________________________________________________________
//  Redéfinition de fputc et fgetc pour stdio.h passant par un buffer interruptif
